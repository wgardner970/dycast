...
SELECT AddGeometryColumn('public', 'analysis_areas_unprojected', 'the_geom', 29193, 'MULTIPOLYGON', 2);

SELECT AddGeometryColumn('public', 'analysis_areas_projected', 'the_geom', 29193, 'MULTIPOLYGON', 2);
